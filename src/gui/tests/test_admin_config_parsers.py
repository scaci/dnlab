...
"""
    ...
    assert entries["log_dir_multinode"].known is True
    ...
    assert "log_dir_multinode: /var/log/dnlab-multinode" in dumped
...
log_dir_multinode: {tmp_path}/missing-log-multinode
